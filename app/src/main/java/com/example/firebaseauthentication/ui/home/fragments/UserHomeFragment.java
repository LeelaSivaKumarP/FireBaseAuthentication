...
public class UserHomeFragment extends Fragment {
    ...
    private PerformSignOut performeSignOut;
    TextView textView;
    Button signOutBtn;
    ...
    private void initViews(View view) {
        textView = view.findViewById(R.id.heading_tv);
        signOutBtn = view.findViewById(R.id.sign_out);
        textView.setText(mFirebaseUser.getProviderId());
        signOutBtn.setOnClickListener( v -> {
            performeSignOut.signOut();
        });
    }
    ...
    public void setListener(PerformSignOut performeSignOut) {
        this.performeSignOut = performeSignOut;
    }
}